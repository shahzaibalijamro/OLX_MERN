...
const LoginModal = ({ setIsLoginModalOpen, setIsRegisterOpen }: LoginModalProps) => {
    const closeModal = () => {
            ...
            <div className='modal-box'>
                <div className='flex justify-end'>
                    <div className='w-fit pt-4 ps-4 pe-4'>
                        <svg onClick={closeModal} width="25" className='cursor-pointer' height="25" data-aut-id="icon" viewBox="0 0 1024 1024"><path d="M878.3 85.3L512 451.6 145.7 85.3H85.3v60.4L451.7 512 85.3 878.3v60.4h60.4L512 572.3l366.3 366.4h60.4v-60.4L572.4 512l366.3-366.3V85.3z"></path></svg>
                    </div>
                </div>
