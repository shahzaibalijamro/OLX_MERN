...
const LoginModal = ({setIsLoginModalOpen}:{setIsLoginModalOpen:(value:boolean)=> void}) => {
    ...
    return (
        ...
        </div> : <RegisterModal setIsLoginModalOpen={setIsLoginModalOpen} setIsRegisterOpen={setIsRegisterOpen}/>}
        </>
    )
}
