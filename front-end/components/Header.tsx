...
const Header = () => {
    ...
    useEffect(() => {
        ...
        const isSuggestionShown = localStorage.getItem("suggestion");
    ...
    return (
        <>
            ...
            <div className="myContainer stickyHeaderPC">
                <div className="flex items-center justify-start pt-[16px] pb-[6px]">
                    ...
                    <div className="motorProperty hover:text-[#3a77ff] text-[#002f34] hover:fill-[#3a77ff]">
                    ...
                    <div className="motorProperty text-[#002f34] hover:text-[#3a77ff] hover:fill-[#3a77ff]">
                ...
                {/* Mobile Section */}
                <div className="mt-[16px] headerMobile">
                    <div onClick={() => setIsMobileActive(true)} className="flex justify-start items-center">
                        <div className="mx-2">
                        ...
                        <div className="flex items-center" ref={dropdownRefMobile} >
                            ...
                            }} className={`ms-[8px] dropdown-icon cursor-pointer ${isMobileActive && 'rotate-180'}`}>
                                <DropdownIcon height={width > 820 ? 24 : 16} width={width > 820 ? 24 : 16} />
                            </div>
                        </div>
                    </div>
                    {isMobileActive && <div className="drop-down-box-2 bg-white z-1 w-full rounded">
                        <div className="my-[15px] flex items-center mx-[16px]">
                            <div className="cursor-pointer" onClick={() => setIsMobileActive(false)}>
                                <Image src={Back} alt="Back" />
                            </div>
                            <div className="ms-4">
                                <h1 className="text-[20px] relative bottom-[1px] font-semibold">Location</h1>
                            </div>
                        </div>
                        <div className="mx-[16px]">
                            <div className="w-full my-[15px] px-[10px] py-[12px]  flex justify-start border border-[#d8dfe0] focus-within:border-[#23e5db] focus:border-[#23e5db] rounded">
                                <LocationIcon height={24} width={24} />
                                <div className="w-full flex" >
                                    <input type="text" value={inputLocation} onChange={(e) => setInputLocation(e.target.value)} className="ps-[10px] w-full bg-white focus-visible:border-0 focus-visible:outline-0" />
                ...
                <div className="headerMobile stickyHeaderMobile py-4">
                    <div className="w-full flex justify-start border border-[#d8dfe0] focus-within:border-[#23e5db] focus:border-[#23e5db] rounded">
                        <div className="w-full flex">
                            <div className={`cursor-pointer ps-[10px] pe-[2px] flex justify-start items-center`}>
                                <SearchIcon height={24} width={24} color="#002f34" />
                            </div>
                            <input type="text" placeholder="Find Cars, Mobile Phones and More..." className="w-full bg-white ms-[10px] my-[12px] placeholder:text-[#7d7575] focus-visible:border-0 focus-visible:outline-0" />
                        </div>
                    </div>
